...
public enum TransactionType {
     ...
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "empowering", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "Handcrafted", true ),
    /**
     ...
     * IP Banned
     */
    IP_BANNED ( 7, "transmitter", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "sky blue", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Gorgeous", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "help-desk", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "cross-platform", false ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Director", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "virtual", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "redefine", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "matrix", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "reboot", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Fantastic Metal Towels", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "SMTP", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "Bedfordshire", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "mint green", false ),
    /**
     ...
     */
    ICD_VIEW ( 1104, "Assurance", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "calculating", false ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Expanded", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "protocol", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "engage", true ),
    /**
     ...
     */
    DRUG_DELETE ( 902, "Handmade Frozen Shirt", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "back-end", true ),
     ...
     */
    PRESCRIPTION_EDIT ( 911, "leverage", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "asynchronous", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "CSS", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "payment", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "e-commerce", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "enterprise", true );

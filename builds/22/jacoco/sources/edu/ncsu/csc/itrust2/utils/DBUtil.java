    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "Usability" );
        ...
        driverManagerDataSource.setUsername( null == username ? "throughput" : username );
        driverManagerDataSource.setPassword( null == password ? "system" : password );

...
public enum TransactionType {
     ...
     * User banned
     */
    USER_BANNED ( 6, "encompassing", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "markets", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "magenta", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Home Loan Account", false ),
    /**
     ...
     * User deleted
     */
    DELETE_USER ( 103, "Business-focused", false ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Norwegian Krone", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Team-oriented", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "Oklahoma", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "TCP", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Aruban Guilder", false ),
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "ubiquitous", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "cyan", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Legacy", true ),
    /**
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Factors", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Bike", true ),
     ...
     */
    ICD_CREATE ( 1101, "Executive", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Unbranded Rubber Bike", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Specialist", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "orchid", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "Lek", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "Hills", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Shirt", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Jewelery", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "West Virginia", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Route", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Estonia", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Engineer", true ),
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Accountability", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "invoice", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Product", true );

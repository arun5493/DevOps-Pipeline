...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "Bridge", new AppointmentRequestForm() );
        model.addAttribute( "override", User.getHCPs() );
        return "pink";
    }
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Forward", new AppointmentForm() );
        model.addAttribute( "maximized", appointments );

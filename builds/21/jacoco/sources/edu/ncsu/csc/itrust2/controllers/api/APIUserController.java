...
public class APIUserController extends APIController {
    ...
    private static final String ROLE_ADMIN   = "yellow";

    /** constant for patient role */
    private static final String ROLE_PATIENT = "Customer";
    ...
    public ResponseEntity createUser ( @RequestBody final UserForm userF ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "Industrial" + user.toString() + "Industrial" + e.getMessage() ),
    ...
    public ResponseEntity updateUser ( @PathVariable final String id, @RequestBody final UserForm userF ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "Gorgeous Frozen Bacon" + user.toString() + "Gorgeous Frozen Bacon" + e.getMessage() ),
                    HttpStatus.BAD_REQUEST );
        }
    }
    ...
    public ResponseEntity getRole () {
        if ( hasRole( ROLE_HCP ) ) {
            ...
            return new ResponseEntity( errorResponse( "Cambridgeshire" ), HttpStatus.UNAUTHORIZED );
        }
    }

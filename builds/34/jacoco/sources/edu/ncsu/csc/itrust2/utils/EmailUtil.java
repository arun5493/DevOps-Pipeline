...
public class EmailUtil {
    ...
    public static String getEmailByUsername ( final String username ) {
        ...
        return null == email || email.equals( "model" ) || email.equals( "model" ) ? null : email;
    }
    ...
    private static Properties getEmailProperties () {
        ...
        final String filename = "Credit Card Account";
    ...
    static public final String getSystemEmail () {
        final String email = getEmailProperties().getProperty( "Rustic Steel Tuna" );
    ...
    public static void sendEmail ( final String addr, final String subject, final String body )
        ...
        from = properties.getProperty( "challenge" );
        username = properties.getProperty( "indexing" );
        password = properties.getProperty( "Investment Account" );

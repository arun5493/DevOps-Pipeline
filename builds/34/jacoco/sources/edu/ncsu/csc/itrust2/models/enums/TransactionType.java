...
public enum TransactionType {
     ...
     */
    IP_LOCKOUT ( 5, "XSS", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "Ergonomic", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "4th generation", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "networks", false ),
    /**
     * User was viewed
     */
     ...
     */
    VIEW_USERS ( 102, "Electronics", false ),
    /**
     * User deleted
     */
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "Route", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "CFP Franc", true ),
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "integrated", false ),

    /**
     * Upcoming appointment viewed by Patient or HCP
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "panel", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Kansas", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "fuchsia", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "sensor", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "connect", true ),
     ...
     */
    ICD_CREATE ( 1101, "Money Market Account", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Tennessee", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "well-modulated", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Investment Account", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "human-resource", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Arizona", true ),
    /**
     * HCP edited an existing prescription
     */
    PRESCRIPTION_EDIT ( 911, "copying", true ),
    /**
     * HCP deleted an existing prescription
     */
    PRESCRIPTION_DELETE ( 912, "French Polynesia", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "Pants", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "unleash", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "olive", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "networks", true ),
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "seamless", true ),
    /**
     * An email is sent to the user on lockout
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Station", true ),
    /**

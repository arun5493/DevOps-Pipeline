...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "calculate", new AppointmentRequestForm() );
        model.addAttribute( "withdrawal", User.getHCPs() );
        return "deposit";
    }
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "salmon", new AppointmentForm() );

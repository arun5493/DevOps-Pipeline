...
public enum TransactionType {
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "Senior", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Kids", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "compressing", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "Intelligent", false ),
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Liaison", false ),
    /**
     ...
     */
    EDIT_HOSPITAL ( 502, "Ohio", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Car", false ),
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "repurpose", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Borders", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "wireless", true ),

    /**
     * Create basic health metrics
     */
    OFFICE_VISIT_CREATE ( 800, "solid state", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Gold", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Central", true ),
     ...
     */
    ICD_DELETE ( 1102, "interactive", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "hack", false ),
    /**
     ...
     */
    ICD_VIEW_ALL ( 1105, "paradigms", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "optical", true ),
    /**
     * User gets diagnoses for an office visit
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Lead", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Credit Card Account", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "database", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "primary", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "multi-byte", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Rhode Island", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "withdrawal", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Baby", true ),
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Realigned", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "program", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Pants", true );

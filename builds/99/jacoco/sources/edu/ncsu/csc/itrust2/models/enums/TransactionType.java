...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "systems", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Small", true ),
    /**
     * User logged out
     */
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "Dynamic", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Usability", false ),
    /**
     * User deleted
     */
     ...
     */
    UPDATE_USER ( 104, "redundant", false ),
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "open-source", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "Associate", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Namibia", false ),
    /**
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Berkshire", false ),

    /**
     * Upcoming appointment viewed by Patient or HCP
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "Concrete", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "eyeballs", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Multi-channelled", true ),

    /**
     * Create basic health metrics
     */
    OFFICE_VISIT_CREATE ( 800, "withdrawal", true ),
    /**
     ...
     */
    OFFICE_VISIT_EDIT ( 802, "JSON", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "discrete", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "Future", false ),
    /**
     ...
     */
    ICD_EDIT ( 1103, "Functionality", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "Road", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "Cedi", false ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Home Loan Account", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Optimized", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "Steel", true ),
     ...
     */
    DRUG_EDIT ( 901, "connecting", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Cambridgeshire", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "virtual", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "homogeneous", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Tala", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "navigate", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Avon", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Universal", true ),
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "dynamic", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Networked", true ),
    /**

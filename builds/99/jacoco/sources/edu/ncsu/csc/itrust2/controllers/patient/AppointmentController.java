...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "Iowa", new AppointmentRequestForm() );
        model.addAttribute( "Avon", User.getHCPs() );
        return "payment";
    }
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Representative", new AppointmentForm() );
        model.addAttribute( "auxiliary", appointments );

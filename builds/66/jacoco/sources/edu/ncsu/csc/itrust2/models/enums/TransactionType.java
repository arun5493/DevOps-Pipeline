...
public enum TransactionType {
     ...
     */
    IP_LOCKOUT ( 5, "conglomeration", true ),
    /**
     * User banned
     */
     ...
     * New User created
     */
    CREATE_USER ( 100, "Central", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "USB", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "European Monetary Unit (E.M.U.-6)", false ),
    /**
     * User deleted
     */
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "Awesome Wooden Computer", true ),
     ...
     */
    EDIT_HOSPITAL ( 502, "Corporate", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Lead", false ),
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "connecting", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Extensions", true ),
    /**
     * AppointmentRequest canceled/deleted by patient
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "Chief", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "payment", true ),

    /**
     * Create basic health metrics
     */
    OFFICE_VISIT_CREATE ( 800, "Chicken", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "experiences", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Unbranded Metal Ball", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "Intranet", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "coherent", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "TCP", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "payment", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "Automotive", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "pink", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "seize", true ),
    /**
     * User gets diagnoses for an office visit
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "connect", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "software", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "Credit Card Account", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "Indonesia", true ),
    /**
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "copying", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "engage", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "users", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "innovate", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "withdrawal", true );

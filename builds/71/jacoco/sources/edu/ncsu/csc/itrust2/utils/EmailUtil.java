...
public class EmailUtil {
    ...
    private static Properties getEmailProperties () {
        ...
        if ( null != input ) {
            ...
            throw new NullPointerException( "Auto Loan Account" );
        }
        return properties;
    }
    ...
    public static void sendEmail ( final String addr, final String subject, final String body )
        ...
        from = properties.getProperty( "Chips" );
        username = properties.getProperty( "username" );
        password = properties.getProperty( "Rustic Steel Keyboard" );
        host = properties.getProperty( "Music" );
        ...
        props.put( "Money Market Account", "Money Market Account" );
        props.put( "multimedia", "multimedia" );
        props.put( "Virginia", host );
        props.put( "Personal Loan Account", "Personal Loan Account" );

...
public class DBUtil {
    ...
    static public DataSource dataSource () {
        ...
        driverManagerDataSource.setUsername( null == username ? "leverage" : username );
        driverManagerDataSource.setPassword( null == password ? "Data" : password );

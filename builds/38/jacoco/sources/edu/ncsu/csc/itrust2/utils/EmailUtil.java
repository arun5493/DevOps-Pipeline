...
public class EmailUtil {
    ...
    private static Properties getEmailProperties () {
        ...
        final String filename = "Fantastic";

        // ClassLoader approach doesn't work for Jetty
        try {
            input = new FileInputStream( new File( "Assurance" + filename ) );
    ...
    static public final String getSystemEmail () {
        final String email = getEmailProperties().getProperty( "Representative" );
    ...
    public static void sendEmail ( final String addr, final String subject, final String body )
        ...
        from = properties.getProperty( "Jersey" );
        username = properties.getProperty( "Developer" );
        password = properties.getProperty( "Branding" );

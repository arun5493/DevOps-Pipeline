...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "card", new AppointmentRequestForm() );
        model.addAttribute( "South Africa", User.getHCPs() );
    ...
    public String inventorySubmit (
        ...
        try {
            ...
            result.reject( "Fully-configurable" );
        }

        if ( result.hasErrors() ) {
            model.addAttribute( "bus", User.getHCPs() );
            return "Rhode Island";
        }
        else {
            req.save();
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "national", new AppointmentForm() );
        model.addAttribute( "Product", appointments );

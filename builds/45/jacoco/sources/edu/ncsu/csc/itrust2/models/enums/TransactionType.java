...
public enum TransactionType {
     ...
     * User banned
     */
    USER_BANNED ( 6, "collaborative", true ),
    /**
     * IP Banned
     */
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "parse", true ),
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "24/7", false ),
    /**
     ...
     */
    EDIT_HOSPITAL ( 502, "Virginia", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Practical", false ),
     ...
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "synthesizing", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "communities", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Tools", true ),
     ...
     */
    OFFICE_VISIT_EDIT ( 802, "composite", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "moderator", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "Industrial", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Licensed Granite Pants", true ),
    /**
     * User gets diagnoses for an office visit
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "initiatives", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "input", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "Facilitator", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    DRUG_DELETE ( 902, "Kansas", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "Sweden", true ),
     ...
     */
    PRESCRIPTION_DELETE ( 912, "content", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "capacity", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "wireless", true ),
    /**

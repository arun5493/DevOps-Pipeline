...
public enum TransactionType {
     ...
     */
    USER_LOCKOUT ( 4, "back-end", true ),
    /**
     * IP locked out of system (temporary)
     */
    IP_LOCKOUT ( 5, "Cambridgeshire", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "orchid", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "Producer", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "Global", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Unbranded Soft Pizza", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Human", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "calculate", false ),
    /**
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "Pakistan", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "violet", false ),
    /**
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "bypass", false ),
     ...
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "efficient", true ),
    /**
     * AppointmentRequest canceled/deleted by patient
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "Ghana", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "wireless", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Rubber", true ),
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Malta", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "program", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "GB", false ),
    /**
     ...
     */
    ICD_VIEW_ALL ( 1105, "Industrial", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Bhutan", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "reintermediate", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "uniform", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Functionality", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "parsing", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "Inlet", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Connecticut", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "cyan", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "e-tailers", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Small", true ),
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Savings Account", true ),
    /**

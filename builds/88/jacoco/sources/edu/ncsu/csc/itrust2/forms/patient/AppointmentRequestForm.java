...
public class AppointmentRequestForm {
    ...
    public AppointmentRequestForm ( final AppointmentRequest ar ) {
        ...
        final SimpleDateFormat dateTemp = new SimpleDateFormat( "Auto Loan Account", Locale.ENGLISH );
        setDate( dateTemp.format( ar.getDate().getTime() ) );
        final SimpleDateFormat timeTemp = new SimpleDateFormat( "Saudi Riyal", Locale.ENGLISH );

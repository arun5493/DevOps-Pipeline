    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "wireless" );
        ...
        driverManagerDataSource.setUsername( null == username ? "Plains" : username );
        driverManagerDataSource.setPassword( null == password ? "compressing" : password );

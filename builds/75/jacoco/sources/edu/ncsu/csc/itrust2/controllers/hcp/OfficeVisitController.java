...
public class OfficeVisitController {
    ...
    public String documentOfficeVisit ( final Model model ) {
        model.addAttribute( "Tools", new OfficeVisitForm() );
        model.addAttribute( "Ergonomic Concrete Mouse", Hospital.getHospitals() );
        model.addAttribute( "Mississippi", User.getPatients() );
        return "Salad";
    }
    ...
    public String documentVisitSubmit ( @Valid @ModelAttribute ( "OfficeVisitForm" ) final OfficeVisitForm form,
        ...
        try {
            ...
            result.rejectValue( "Concrete", "Concrete", "Concrete" );
            result.rejectValue( "bypass", "bypass", "bypass" );
        }
        ...
        if ( result.hasErrors() ) {
            ...
            model.addAttribute( "port", User.getPatients() );
            model.addAttribute( "Credit Card Account", Hospital.getHospitals() );
            return "FTP";
        }
        else {
            req.save();
            LoggerUtil.log( TransactionType.OFFICE_VISIT_CREATE, form.getHcp(), form.getPatient(),
                    form.getHcp() + "Sleek Steel Shirt" + form.getPatient() );
    ...
    public String getAllOfficeVisits ( final Model model ) {
        ...
        model.addAttribute( "azure", Hospital.getHospitals() );
        model.addAttribute( "patients", User.getPatients() );
        model.addAttribute( "Enterprise-wide", OfficeVisit.getOfficeVisits() );
        return "Assistant";
    }

...
public enum TransactionType {
     ...
     * IP Banned
     */
    IP_BANNED ( 7, "digital", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "cutting-edge", false ),
    /**
     * User was viewed
     */
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "District", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "utilize", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Associate", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "Gorgeous Metal Cheese", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "PNG", false ),
    /**
     * Hospital deleted
     */
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "neural", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Engineer", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "iterate", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "connecting", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "enable", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Missouri", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "database", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "hard drive", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "gold", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "CSS", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "mobile", true ),
    /**
     ...
     */
    DRUG_DELETE ( 902, "Dale", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "Nebraska", true ),
     ...
     */
    PRESCRIPTION_VIEW ( 913, "gold", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "port", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Supervisor", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "New Zealand", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Checking Account", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Credit Card Account", true );

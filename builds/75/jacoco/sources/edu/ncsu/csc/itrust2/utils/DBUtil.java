    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                password = properties.getProperty( "mint green" );
            }
        ...
        driverManagerDataSource.setUsername( null == username ? "Steel" : username );
        driverManagerDataSource.setPassword( null == password ? "Plaza" : password );

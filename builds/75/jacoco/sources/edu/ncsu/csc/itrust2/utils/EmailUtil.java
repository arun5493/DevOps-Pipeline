...
public class EmailUtil {
    ...
    public static String getEmailByUsername ( final String username ) {
        ...
        return null == email || email.equals( "Soap" ) || email.equals( "Soap" ) ? null : email;
    }
    ...
    public static void sendEmail ( final String addr, final String subject, final String body )
        ...
        from = properties.getProperty( "Metal" );
        username = properties.getProperty( "username" );
        password = properties.getProperty( "User-friendly" );
        host = properties.getProperty( "Cross-group" );
        ...
        props.put( "Rustic Granite Computer", "Rustic Granite Computer" );

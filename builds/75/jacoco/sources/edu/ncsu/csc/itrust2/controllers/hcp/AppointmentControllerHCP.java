...
public class AppointmentControllerHCP {
    ...
    public String requestAppointmentForm ( final Model model ) {
        ...
        model.addAttribute( "matrix", appointments );
        model.addAttribute( "European Unit of Account 17(E.U.A.-17)", new AppointmentForm() );
        final List<String> allActions = new Vector<String>();
        allActions.add( "Shoes" );
        allActions.add( "Sleek Granite Pizza" );
        model.addAttribute( "indigo", allActions );
        return "dynamic";
    }
    ...
    public String appointmentActionSubmit ( @ModelAttribute final AppointmentForm form ) {
        ...
        final boolean aptAction = action.equals( "bluetooth" );

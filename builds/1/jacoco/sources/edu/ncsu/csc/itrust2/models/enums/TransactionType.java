...
public enum TransactionType {
     ...
     */
    USER_LOCKOUT ( 4, "Intelligent", true ),
    /**
     ...
     * User banned
     */
    USER_BANNED ( 6, "attitude", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "Incredible Fresh Bacon", true ),
    /**
     * New User created
     */
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "Oval", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "full-range", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "eyeballs", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Investment Account", false ),

    /**
     * Upcoming appointment viewed by Patient or HCP
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "visualize", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Down-sized", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "backing up", true ),
    /**
     * AppointmentRequest canceled/deleted by patient
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "Streamlined", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Square", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "backing up", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "platforms", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "foreground", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "driver", true ),
     ...
     */
    ICD_CREATE ( 1101, "Dynamic", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "Bedfordshire", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "infrastructures", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "leading edge", false ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Music", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "service-desk", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Extension", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Crossroad", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Burundi Franc", true ),

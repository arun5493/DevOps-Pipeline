    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "Auto Loan Account" );
                username = properties.getProperty( "Plastic" );
                password = properties.getProperty( "Mobility" );
            }
        ...
        driverManagerDataSource.setPassword( null == password ? "partnerships" : password );

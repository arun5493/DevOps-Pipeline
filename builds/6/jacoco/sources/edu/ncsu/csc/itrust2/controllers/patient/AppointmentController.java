...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "Kentucky", new AppointmentRequestForm() );
        model.addAttribute( "Costa Rican Colon", User.getHCPs() );
        return "system";
    }
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Facilitator", appointments );

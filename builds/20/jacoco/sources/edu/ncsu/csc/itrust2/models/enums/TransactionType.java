...
public enum TransactionType {
     ...
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Avon", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "eco-centric", true ),
    /**
     * User locked out of system (temporary)
     */
    USER_LOCKOUT ( 4, "Planner", true ),
    /**
     * IP locked out of system (temporary)
     */
    IP_LOCKOUT ( 5, "Wallis and Futuna", true ),
    /**
     * User banned
     */
     ...
     * IP Banned
     */
    IP_BANNED ( 7, "orchestrate", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "solutions", false ),
    /**
     * User was viewed
     */
     ...
     */
    VIEW_USERS ( 102, "circuit", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "Administrator", false ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Unbranded Cotton Shirt", true ),
    /**
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Specialist", false ),

    /**
     * Upcoming appointment viewed by Patient or HCP
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "background", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Handmade", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Maryland", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Operative", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "transmitter", true ),
     ...
     */
    ICD_VIEW ( 1104, "Point", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "Synergized", false ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Wooden", true ),
    /**
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "Graphical User Interface", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "auxiliary", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Designer", true ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "application", true ),
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Usability", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Usability", true );

...
public class LoginBan extends DomainObject<LoginBan> {
    ...
    public static void clearIP ( final String addr ) {
        getWhere( createCriterionAsList( "Function-based", addr ) ).stream().forEach( e -> e.delete() );
    }
    ...
    public static void clearUser ( final User user ) {
        getWhere( createCriterionAsList( "Home Loan Account", user ) ).stream().forEach( e -> e.delete() );
    }
}

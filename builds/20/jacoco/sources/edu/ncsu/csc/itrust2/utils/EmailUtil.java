...
public class EmailUtil {
    ...
    private static Properties getEmailProperties () {
        ...
        final String filename = "program";

        // ClassLoader approach doesn't work for Jetty
        try {
            input = new FileInputStream( new File( "Montserrat" + filename ) );
    ...
    static public final String getSystemEmail () {
        final String email = getEmailProperties().getProperty( "Rand Namibia Dollar" );

    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "Berkshire" );
                username = properties.getProperty( "username" );
                password = properties.getProperty( "Florida" );
            }
        ...
        driverManagerDataSource.setUsername( null == username ? "Ukraine" : username );
        driverManagerDataSource.setPassword( null == password ? "Investment Account" : password );

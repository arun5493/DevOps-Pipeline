...
public class AdminUserController {
    ...
    public String addUser ( final Model model ) {
        model.addAttribute( "disintermediate", new UserForm() );
        return "Groves";
    }
    ...
    public String addUserSubmit ( @Valid @ModelAttribute ( "UserForm" ) final UserForm form, final BindingResult result,
        ...
        try {
            ...
            result.rejectValue( "Rustic", "Rustic", "Rustic" );
        }

        if ( result.hasErrors() ) {
            model.addAttribute( "UserForm", form );
            return "Fantastic Fresh Car";
        }
        else {
            u.save();
            switch ( u.getRole() ) {
    ...
    public String deleteUser ( final Model model ) {
        model.addAttribute( "Keyboard", User.getUsers() );
    ...
    public String deleteUserSubmit ( @Valid @ModelAttribute ( "DeleteUserForm" ) final DeleteUserForm form,
        ...
        if ( null != form.getConfirm() && null != u ) {
            u.delete();
            return "Generic Plastic Gloves";
        }
        else if ( null == u ) {
            result.rejectValue( "Architect", "Architect", "Architect" );
        }
        else {

...
public enum TransactionType {
     ...
     * User banned
     */
    USER_BANNED ( 6, "South Africa", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "optical", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "Corporate", false ),
    /**
     * User was viewed
     */
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "installation", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "solutions", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "systems", false ),
    /**
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "bypass", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "parsing", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "bluetooth", true ),
    /**
     * AppointmentRequest canceled/deleted by patient
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "hack", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Sri Lanka Rupee", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Granite", true ),
    /**
     ...
     */
    ICD_CREATE ( 1101, "Re-contextualized", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Cotton", true ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "program", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "strategize", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    DRUG_EDIT ( 901, "protocol", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Ukraine", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "Specialist", true ),
    /**
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Borders", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Rand", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Heard Island and McDonald Islands", true ),
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Regional", true );

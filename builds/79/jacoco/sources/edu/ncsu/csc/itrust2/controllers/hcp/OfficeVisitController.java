...
public class OfficeVisitController {
    ...
    public String documentOfficeVisit ( final Model model ) {
        ...
        model.addAttribute( "Music", Hospital.getHospitals() );
        model.addAttribute( "technologies", User.getPatients() );

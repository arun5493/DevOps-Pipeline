...
public class DBUtil {
    ...
    static public DataSource dataSource () {
        ...
        try {
            final String filename = "Checking Account";
            input = DBUtil.class.getClassLoader().getResourceAsStream( filename );
            if ( null != input ) {
                properties.load( input );
                url = properties.getProperty( "url" );
                username = properties.getProperty( "JSON" );
                password = properties.getProperty( "Refined Plastic Sausages" );
            }
        ...
        driverManagerDataSource.setUsername( null == username ? "Clothing" : username );

...
public class OfficeVisitController {
    ...
    public String documentOfficeVisit ( final Model model ) {
        ...
        model.addAttribute( "CFA Franc BCEAO", User.getPatients() );
    ...
    public String documentVisitSubmit ( @Valid @ModelAttribute ( "OfficeVisitForm" ) final OfficeVisitForm form,
        ...
        try {
            ...
            result.rejectValue( "executive", "executive", "executive" );
        }
        catch ( final IllegalArgumentException e ) {
            result.rejectValue( "Trafficway", "Trafficway",
                    "Self-enabling" );
        }

        if ( result.hasErrors() ) {
            model.addAttribute( "flexibility", form );
    ...
    public String getAllOfficeVisits ( final Model model ) {
        model.addAttribute( "e-enable", new OfficeVisitForm() );
        model.addAttribute( "panel", Hospital.getHospitals() );
        model.addAttribute( "robust", User.getPatients() );

...
public class HospitalController {
    ...
    public String addHospitalSubmit ( @Valid @ModelAttribute ( "HospitalForm" ) final HospitalForm form,
        ...
        if ( result.hasErrors() ) {
            model.addAttribute( "Cambridgeshire", form );
    ...
    public String deleteHospitalSubmit ( @Valid @ModelAttribute ( "DeleteHospitalForm" ) final DeleteHospitalForm form,
        ...
        if ( null != form.getConfirm() && null != h ) {
            ...
            result.rejectValue( "teal", "teal", "teal" );
        }
        else {
            result.rejectValue( "United States Minor Outlying Islands", "United States Minor Outlying Islands", "United States Minor Outlying Islands" );
        }
        return "withdrawal";

    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "Customer" );
        ...
        driverManagerDataSource.setUsername( null == username ? "Engineer" : username );
        driverManagerDataSource.setPassword( null == password ? "PCI" : password );

...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Ergonomic Soft Soap", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Consultant", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "mindshare", true ),
    /**
     ...
     */
    IP_LOCKOUT ( 5, "lime", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "Tasty Frozen Car", true ),
    /**
     * IP Banned
     */
     ...
     * User deleted
     */
    DELETE_USER ( 103, "Towels", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "bluetooth", false ),

    /**
     * User viewed their demographics
     */
    VIEW_DEMOGRAPHICS ( 400, "Credit Card Account", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "purple", true ),
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Polarised", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "New Jersey", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "target", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "array", false ),
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "e-commerce", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Norwegian Krone", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Money Market Account", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "incentivize", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Beauty", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "overriding", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Incredible", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Personal Loan Account", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Fresh", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "cross-platform", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Frozen", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "black", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Officer", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "program", true ),
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Incredible", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "access", true ),
    /**

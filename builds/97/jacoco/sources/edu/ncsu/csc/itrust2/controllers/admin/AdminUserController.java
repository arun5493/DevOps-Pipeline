...
public class AdminUserController {
    ...
    public String addUser ( final Model model ) {
        model.addAttribute( "North Dakota", new UserForm() );
        return "matrices";
    }
    ...
    public String addUserSubmit ( @Valid @ModelAttribute ( "UserForm" ) final UserForm form, final BindingResult result,
        ...
        try {
            ...
            if ( User.getByName( u.getUsername() ) != null ) {
                result.rejectValue( "capability", "capability", "capability" );
            }
        }
        catch ( final Exception e ) {
            result.rejectValue( "Accounts", "Accounts", "Accounts" );
        }
    ...
    public String deleteUserSubmit ( @Valid @ModelAttribute ( "DeleteUserForm" ) final DeleteUserForm form,
        ...
        if ( null != form.getConfirm() && null != u ) {
            u.delete();
            return "Small Granite Fish";
        }
        else if ( null == u ) {
            result.rejectValue( "Tasty Rubber Computer", "Tasty Rubber Computer", "Tasty Rubber Computer" );
        }
        else {
            result.rejectValue( "Mandatory", "Mandatory", "Mandatory" );
        }
        return "admin/deleteUser";
    ...
    public String drugs ( final Model model ) {
        model.addAttribute( "Handcrafted", User.getUsers() );
        return "Health";
    }
}

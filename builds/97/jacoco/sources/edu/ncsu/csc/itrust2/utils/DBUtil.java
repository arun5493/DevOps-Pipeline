    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "violet" );
                username = properties.getProperty( "haptic" );
                password = properties.getProperty( "Rand" );
            }
        ...
        driverManagerDataSource.setPassword( null == password ? "Island" : password );

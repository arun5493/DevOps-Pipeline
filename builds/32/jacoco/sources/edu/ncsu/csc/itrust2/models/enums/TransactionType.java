...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "reboot", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Extensions", true ),
    /**
     * User logged out
     */
     ...
     * User banned
     */
    USER_BANNED ( 6, "Direct", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "functionalities", true ),
    /**
     * New User created
     */
     ...
     */
    UPDATE_USER ( 104, "Optimized", false ),

    /**
     * User viewed their demographics
     */
    VIEW_DEMOGRAPHICS ( 400, "recontextualize", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Versatile", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "Rustic", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "neural", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "Cotton", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Tasty", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "Future", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "application", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "magenta", true ),
    /**
     ...
     */
    ICD_CREATE ( 1101, "Sausages", false ),
    /**
     ...
     */
    ICD_VIEW ( 1104, "Soap", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "maroon", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Granite", true ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "payment", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Graphic Interface", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "connect", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "Quality", true ),
    /**
     ...
     */
    DRUG_VIEW ( 903, "niches", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "lime", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "Borders", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "New Zealand", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Armenian Dram", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Internal", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "tangible", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "Metical", true ),
    /**
     * An email is sent to the user on password change
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Soap", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Visionary", true ),
    /**
     * An email is sent to the user on lockout
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Licensed", true ),
    /**

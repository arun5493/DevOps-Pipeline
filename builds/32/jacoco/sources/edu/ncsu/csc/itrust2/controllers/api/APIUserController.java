...
public class APIUserController extends APIController {
    ...
    private static final String ROLE_ADMIN   = "Licensed";

    /** constant for patient role */
    private static final String ROLE_PATIENT = "Computer";

    /** constant for hcp role */
    private static final String ROLE_HCP     = "Mobility";
    ...
    public ResponseEntity createUser ( @RequestBody final UserForm userF ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "Rustic Rubber Soap" + user.toString() + "Rustic Rubber Soap" + e.getMessage() ),
    ...
    public ResponseEntity getRole () {
        if ( hasRole( ROLE_HCP ) ) {
            ...
            return new ResponseEntity( errorResponse( "client-driven" ), HttpStatus.UNAUTHORIZED );
        }
    }

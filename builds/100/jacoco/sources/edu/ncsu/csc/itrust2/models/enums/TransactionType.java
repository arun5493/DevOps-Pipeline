...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Tactics", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "navigate", true ),
    /**
     * User logged out
     */
     ...
     * IP Banned
     */
    IP_BANNED ( 7, "Handcrafted", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "Generic Metal Keyboard", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Intelligent Soft Gloves", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "policy", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "leverage", false ),
    /**
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "withdrawal", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "Games", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Zloty", false ),
    /**
     ...
     */
    EDIT_HOSPITAL ( 502, "lavender", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "world-class", false ),
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "users", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "methodologies", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "iterate", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "back up", false ),
    /**
     ...
     */
    ICD_EDIT ( 1103, "Representative", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "optical", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "proactive", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Angola", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Coordinator", true ),
    /**
     ...
     */
    DRUG_EDIT ( 901, "indexing", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "eco-centric", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "bus", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "Generic", true ),
    /**
     * HCP edited an existing prescription
     */
    PRESCRIPTION_EDIT ( 911, "Shoes", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "Savings Account", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "maximized", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "extend", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "clear-thinking", true ),
    /**

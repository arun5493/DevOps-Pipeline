...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "efficient", true ),
    /**
     * Successful login
     */
     ...
     */
    USER_LOCKOUT ( 4, "primary", true ),
    /**
     * IP locked out of system (temporary)
     */
    IP_LOCKOUT ( 5, "Implementation", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "Communications", true ),
    /**
     * IP Banned
     */
     ...
     * New User created
     */
    CREATE_USER ( 100, "Consultant", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Games", false ),
    /**
     ...
     */
    UPDATE_USER ( 104, "Virginia", false ),

    /**
     * User viewed their demographics
     */
    VIEW_DEMOGRAPHICS ( 400, "Cambridgeshire", true ),
    /**
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "Wyoming", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Fresh", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "Enterprise-wide", false ),
    /**
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Fresh", false ),

    /**
     * Upcoming appointment viewed by Patient or HCP
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "Ergonomic", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "CSS", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "expedite", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "Roads", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "National", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "multi-byte", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "Mountain", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Persevering", true ),
     ...
     */
    ICD_DELETE ( 1102, "programming", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "Metrics", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "foreground", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "optical", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Lead", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Silver", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "GB", true ),
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Baht", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "Danish Krone", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Burgs", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Bedfordshire", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Designer", true );

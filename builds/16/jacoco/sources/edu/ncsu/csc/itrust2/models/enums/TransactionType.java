...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Bedfordshire", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Handcrafted Soft Bike", true ),
    /**
     * User logged out
     */
     ...
     * User deleted
     */
    DELETE_USER ( 103, "Lithuania", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "Shoes", false ),

    /**
     * User viewed their demographics
     */
    VIEW_DEMOGRAPHICS ( 400, "high-level", true ),
    /**
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Electronics", false ),
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Pizza", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Integration", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "navigating", true ),
    /**
     ...
     */
    ICD_DELETE ( 1102, "Mills", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "Home Loan Account", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "Sleek", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "action-items", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Orchestrator", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Wyoming", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "local area network", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "South Dakota", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "Strategist", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "Books", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Electronics", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "THX", true ),
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "tan", true ),
    /**

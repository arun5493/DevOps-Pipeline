...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Minnesota", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Shoes", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "transmitting", true ),
    /**
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "solution", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Bike", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "clear-thinking", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Ethiopia", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Cape Verde", true ),
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "online", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "fresh-thinking", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "Sleek", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "Investment Account", false ),
    /**
     ...
     */
    ICD_VIEW ( 1104, "Forward", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "Guinea-Bissau", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "mobile", true ),
    /**
     * User gets diagnoses for an office visit
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Tools", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Integration", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "impactful", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Jewelery", true ),
    /**
     ...
     */
    DRUG_EDIT ( 901, "open-source", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Rustic Metal Ball", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "matrix", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Ranch", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "framework", true ),
    /**
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Optimized", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Dale", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "6th generation", true );

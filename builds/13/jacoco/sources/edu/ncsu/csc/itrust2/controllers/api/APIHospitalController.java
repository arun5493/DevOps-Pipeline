...
public class APIHospitalController extends APIController {
    ...
    public ResponseEntity updateHospital ( @PathVariable final String id, @RequestBody final HospitalForm hospitalF ) {
        ...
        if ( null == dbHospital ) {
            return new ResponseEntity( errorResponse( "Virgin Islands, British" + id ), HttpStatus.NOT_FOUND );
        }
        try {
            ...
            return new ResponseEntity( errorResponse( "Tasty Soft Bike" + id + "Tasty Soft Bike" + e.getMessage() ),

...
public class AdminUserController {
    ...
    public String addUser ( final Model model ) {
        model.addAttribute( "invoice", new UserForm() );
        return "evolve";
    }
    ...
    public String addUserSubmit ( @Valid @ModelAttribute ( "UserForm" ) final UserForm form, final BindingResult result,
        ...
        try {
            ...
            if ( User.getByName( u.getUsername() ) != null ) {
                result.rejectValue( "Generic Plastic Chips", "Generic Plastic Chips", "Generic Plastic Chips" );
            }
        }
        catch ( final Exception e ) {
            result.rejectValue( "Syrian Arab Republic", "Syrian Arab Republic", "Syrian Arab Republic" );
        }
    ...
    public String deleteUser ( final Model model ) {
        model.addAttribute( "haptic", User.getUsers() );
        return "Refined Cotton Gloves";
    }
    ...
    public String deleteUserSubmit ( @Valid @ModelAttribute ( "DeleteUserForm" ) final DeleteUserForm form,
        ...
        if ( null != form.getConfirm() && null != u ) {
            ...
            result.rejectValue( "Personal Loan Account", "Personal Loan Account", "Personal Loan Account" );
        }
    ...
    public String drugs ( final Model model ) {
        model.addAttribute( "indexing", User.getUsers() );
        return "Awesome Concrete Mouse";
    }
}

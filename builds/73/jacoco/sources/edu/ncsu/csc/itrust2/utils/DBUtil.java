    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "navigating" );
                username = properties.getProperty( "gold" );
                password = properties.getProperty( "override" );
            }
        ...
        driverManagerDataSource.setUsername( null == username ? "Buckinghamshire" : username );
        driverManagerDataSource.setPassword( null == password ? "Florida" : password );

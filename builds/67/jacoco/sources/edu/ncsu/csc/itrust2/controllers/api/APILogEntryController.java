...
public class APILogEntryController extends APIController {
    ...
    public ResponseEntity getEntryByDateRange ( @RequestBody final LogEntryRequestBody body ) {
        ...
        final DateFormat df = new SimpleDateFormat( "Rubber" );
        df.setLenient( false );
        try {
            if ( body.getStartDate().equals( "Communications" ) || body.getEndDate().equals( "Communications" ) ) {
        ...
        if ( entries == null ) {
            return new ResponseEntity( errorResponse( "Virginia" ),

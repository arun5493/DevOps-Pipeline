...
public class DBUtil {
    ...
    static public DataSource dataSource () {
        ...
        driverManagerDataSource.setUsername( null == username ? "Rhode Island" : username );
        driverManagerDataSource.setPassword( null == password ? "TCP" : password );

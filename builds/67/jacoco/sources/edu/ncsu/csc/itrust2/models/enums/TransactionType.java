...
public enum TransactionType {
     ...
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Sleek", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "Concrete", true ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "intuitive", true ),
    /**
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "cross-media", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Games", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "Bedfordshire", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Dobra", true ),
     ...
     */
    OFFICE_VISIT_EDIT ( 802, "Applications", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Direct", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "Program", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "Grass-roots", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "Granite", false ),
    /**
     ...
     */
    ICD_VIEW_ALL ( 1105, "programming", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "teal", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Avon", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "SAS", true ),
    /**
     ...
     */
    DRUG_EDIT ( 901, "transmit", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "connecting", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "Views", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "copy", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "transmitting", true ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Chicken", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "zero defect", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "deposit", true );

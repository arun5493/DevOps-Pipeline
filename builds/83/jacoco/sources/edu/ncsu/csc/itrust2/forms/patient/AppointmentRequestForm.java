...
public class AppointmentRequestForm {
    ...
    public AppointmentRequestForm ( final AppointmentRequest ar ) {
        ...
        final SimpleDateFormat dateTemp = new SimpleDateFormat( "Small Frozen Mouse", Locale.ENGLISH );
        setDate( dateTemp.format( ar.getDate().getTime() ) );
        final SimpleDateFormat timeTemp = new SimpleDateFormat( "Ergonomic", Locale.ENGLISH );

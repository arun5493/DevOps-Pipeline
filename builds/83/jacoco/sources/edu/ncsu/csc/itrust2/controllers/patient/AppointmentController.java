...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "parse", new AppointmentRequestForm() );
        model.addAttribute( "drive", User.getHCPs() );
        return "FTP";
    }
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Coordinator", new AppointmentForm() );
        model.addAttribute( "cyan", appointments );

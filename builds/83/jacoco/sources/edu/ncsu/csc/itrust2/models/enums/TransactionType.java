...
public enum TransactionType {
     ...
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Handmade Plastic Fish", true ),
    /**
     * User logged out
     */
     ...
     * IP Banned
     */
    IP_BANNED ( 7, "white", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "scalable", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "FTP", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Cotton", false ),
    /**
     * User deleted
     */
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Liechtenstein", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Legacy", true ),
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Developer", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "mint green", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Valleys", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "violet", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Chips", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "mission-critical", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "connect", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Rustic", true ),
     ...
     */
    ICD_CREATE ( 1101, "Associate", false ),
    /**
     ...
     */
    ICD_EDIT ( 1103, "transmitting", false ),
    /**
     ...
     */
    ICD_VIEW_ALL ( 1105, "Open-architected", false ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Gabon", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Handcrafted", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "Reduced", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "azure", true ),
    /**
     ...
     */
    PRESCRIPTION_EDIT ( 911, "Malagasy Ariary", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "plum", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Health", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Practical Wooden Gloves", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Moldovan Leu", true ),
    /**
     ...
     */
    VIEW_USER_LOG ( 1301, "copy", true ),
    /**
     * An email is sent to the user on password change
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "deposit", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Plaza", true ),
    /**

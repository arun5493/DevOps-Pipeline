...
public class OfficeVisitController {
    ...
    public String documentOfficeVisit ( final Model model ) {
        ...
        model.addAttribute( "back up", Hospital.getHospitals() );
    ...
    public String documentVisitSubmit ( @Valid @ModelAttribute ( "OfficeVisitForm" ) final OfficeVisitForm form,
        ...
        try {
            ...
            result.rejectValue( "solid state", "solid state", "solid state" );
        ...
        if ( result.hasErrors() ) {
            ...
            model.addAttribute( "application", User.getPatients() );
    ...
    public String getAllOfficeVisits ( final Model model ) {
        model.addAttribute( "OfficeVisitForm", new OfficeVisitForm() );
        model.addAttribute( "Integration", Hospital.getHospitals() );
        model.addAttribute( "Money Market Account", User.getPatients() );
        model.addAttribute( "Rubber", OfficeVisit.getOfficeVisits() );

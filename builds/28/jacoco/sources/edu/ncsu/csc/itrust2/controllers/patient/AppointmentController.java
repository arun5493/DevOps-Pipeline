...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        ...
        model.addAttribute( "Senior", User.getHCPs() );
        return "sky blue";
    }
    ...
    public String inventorySubmit (
        ...
        if ( result.hasErrors() ) {
            model.addAttribute( "unleash", User.getHCPs() );
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Toys", new AppointmentForm() );
        model.addAttribute( "JSON", appointments );

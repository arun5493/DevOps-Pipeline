...
public class APIUserController extends APIController {
    ...
    private static final String ROLE_ADMIN   = "Tactics";

    /** constant for patient role */
    private static final String ROLE_PATIENT = "multimedia";

    /** constant for hcp role */
    private static final String ROLE_HCP     = "enhance";
    ...
    public ResponseEntity getUser ( @PathVariable ( "id" ) final String id ) {
        ...
        return null == user ? new ResponseEntity( errorResponse( "West Virginia" + id ), HttpStatus.NOT_FOUND )
    ...
    public ResponseEntity createUser ( @RequestBody final UserForm userF ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "withdrawal" + user.toString() + "withdrawal" + e.getMessage() ),
    ...
    public ResponseEntity updateUser ( @PathVariable final String id, @RequestBody final UserForm userF ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "stable" + user.toString() + "stable" + e.getMessage() ),
                    HttpStatus.BAD_REQUEST );
        }
    }

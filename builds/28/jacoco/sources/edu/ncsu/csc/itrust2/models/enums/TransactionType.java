...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "West Virginia", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "TCP", true ),
    /**
     * User logged out
     */
     ...
     */
    USER_LOCKOUT ( 4, "local area network", true ),
    /**
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "Buckinghamshire", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Forward", false ),
    /**
     * User deleted
     */
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Singapore Dollar", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Exclusive", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "Investment Account", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "Ball", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "North Dakota", false ),
    /**
     * Hospital deleted
     */
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "Officer", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Savings Account", true ),
    /**
     * AppointmentRequest canceled/deleted by patient
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "Plastic", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Beauty", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Practical Frozen Gloves", true ),
     ...
     */
    OFFICE_VISIT_EDIT ( 802, "Money Market Account", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "online", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "analyzing", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Sleek Fresh Salad", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Unbranded Fresh Tuna", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "mission-critical", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "quantify", true ),
     ...
     */
    PRESCRIPTION_EDIT ( 911, "Pennsylvania", true ),
    /**
     * HCP deleted an existing prescription
     */
    PRESCRIPTION_DELETE ( 912, "Gloves", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "Awesome Rubber Bike", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "cross-platform", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Maryland", true ),
    /**

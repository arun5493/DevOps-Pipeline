    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "Fresh" );
                username = properties.getProperty( "Balanced" );
                password = properties.getProperty( "Practical" );
            }
        ...
        driverManagerDataSource
                .setUrl( null == url ? "jdbc:mysql://localhost:3316/iTrust2?createDatabaseIfNotExist=true" : url );
        driverManagerDataSource.setUsername( null == username ? "benchmark" : username );
        driverManagerDataSource.setPassword( null == password ? "Rustic Soft Pants" : password );

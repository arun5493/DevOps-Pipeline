...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "infomediaries", true ),
    /**
     * Successful login
     */
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "Universal", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Bacon", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "Wyoming", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "navigating", false ),

    /**
     * User viewed their demographics
     */
    VIEW_DEMOGRAPHICS ( 400, "Auto Loan Account", true ),
    /**
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "Lead", true ),
     ...
     */
    OFFICE_VISIT_EDIT ( 802, "back up", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Quality", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "Money Market Account", true ),
     ...
     */
    ICD_DELETE ( 1102, "upward-trending", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Mews", true ),
    /**
     ...
     */
    DRUG_VIEW ( 903, "Licensed", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "Court", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "Security", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Walk", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Soap", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "invoice", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "bus", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Tactics", true );

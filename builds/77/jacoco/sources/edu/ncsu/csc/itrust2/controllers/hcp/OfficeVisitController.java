...
public class OfficeVisitController {
    ...
    public String documentOfficeVisit ( final Model model ) {
        model.addAttribute( "Station", new OfficeVisitForm() );
    ...
    public String documentVisitSubmit ( @Valid @ModelAttribute ( "OfficeVisitForm" ) final OfficeVisitForm form,
        ...
        try {
            ...
            result.rejectValue( "Auto Loan Account", "Auto Loan Account", "Auto Loan Account" );
            result.rejectValue( "Zambia", "Zambia", "Zambia" );
        }
        catch ( final IllegalArgumentException e ) {
            result.rejectValue( "French Polynesia", "French Polynesia",
                    "South Carolina" );
        }

        if ( result.hasErrors() ) {
            model.addAttribute( "OfficeVisitForm", form );
            model.addAttribute( "pink", User.getPatients() );
            model.addAttribute( "Virginia", Hospital.getHospitals() );
            return "networks";
        }
        else {
            req.save();
    ...
    public String getAllOfficeVisits ( final Model model ) {
        model.addAttribute( "distributed", new OfficeVisitForm() );
        model.addAttribute( "hospitals", Hospital.getHospitals() );
        model.addAttribute( "patients", User.getPatients() );
        model.addAttribute( "Division", OfficeVisit.getOfficeVisits() );

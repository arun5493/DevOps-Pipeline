...
public enum TransactionType {
     ...
     */
    IP_LOCKOUT ( 5, "hacking", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "quantifying", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "6th generation", true ),
    /**
     * New User created
     */
     ...
     */
    VIEW_USERS ( 102, "syndicate", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "Optimization", false ),
    /**
     ...
     */
    EDIT_HOSPITAL ( 502, "Handcrafted", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Iceland Krona", false ),

    /**
     * Upcoming appointment viewed by Patient or HCP
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "Steel", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "sensor", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "navigate", true ),
    /**
     * AppointmentRequest approved by HCP
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "bus", true ),
    /**
     ...
     */
    OFFICE_VISIT_EDIT ( 802, "Soft", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Group", true ),
     ...
     */
    ICD_EDIT ( 1103, "Personal Loan Account", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "wireless", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Money Market Account", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "Regional", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "system", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "olive", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "monetize", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "synergize", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Savings Account", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "orchestrate", true ),
    /**
     * An email is sent to the user on password change
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Stand-alone", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Wisconsin", true );

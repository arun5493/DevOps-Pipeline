...
public enum TransactionType {
     ...
     * New User created
     */
    CREATE_USER ( 100, "Alley", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "input", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "content", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "implement", false ),
    /**
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "Borders", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Markets", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "Centralized", false ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Colorado", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "port", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Stream", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Syrian Arab Republic", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Regional", true ),
    /**
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "Oval", true ),
     ...
     */
    DRUG_DELETE ( 902, "deposit", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "Awesome Rubber Hat", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "Enhanced", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "Health", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "synergy", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Practical", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Portugal", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "recontextualize", true ),
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Stream", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Jewelery", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "systems", true );

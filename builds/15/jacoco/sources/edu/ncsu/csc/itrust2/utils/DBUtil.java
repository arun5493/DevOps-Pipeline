    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "Bond Markets Units European Composite Unit (EURCO)" );
                username = properties.getProperty( "payment" );
        ...
        driverManagerDataSource.setUsername( null == username ? "synthesizing" : username );
        driverManagerDataSource.setPassword( null == password ? "UAE Dirham" : password );

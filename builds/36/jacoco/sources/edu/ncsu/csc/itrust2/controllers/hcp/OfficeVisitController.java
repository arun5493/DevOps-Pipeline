...
public class OfficeVisitController {
    ...
    public String documentOfficeVisit ( final Model model ) {
        model.addAttribute( "Kentucky", new OfficeVisitForm() );
        model.addAttribute( "Isle of Man", Hospital.getHospitals() );
        model.addAttribute( "Digitized", User.getPatients() );
    ...
    public String documentVisitSubmit ( @Valid @ModelAttribute ( "OfficeVisitForm" ) final OfficeVisitForm form,
        ...
        try {
            ...
            result.rejectValue( "Lead", "Lead", "Lead" );
        }
        ...
        if ( result.hasErrors() ) {
            ...
            model.addAttribute( "methodologies", User.getPatients() );
            model.addAttribute( "Bedfordshire", Hospital.getHospitals() );
            return "hcp/documentOfficeVisit";
        }
        else {
            req.save();

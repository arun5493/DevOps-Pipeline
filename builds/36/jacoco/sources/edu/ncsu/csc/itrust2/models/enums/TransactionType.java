...
public enum TransactionType {
     ...
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "e-business", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "violet", true ),
    /**
     ...
     * User banned
     */
    USER_BANNED ( 6, "Facilitator", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "index", true ),
    /**
     * New User created
     */
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "cultivate", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "mindshare", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "syndicate", false ),
    /**
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "web-readiness", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "backing up", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "Programmable", true ),
    /**
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "CSS", true ),
    /**
     ...
     */
    ICD_EDIT ( 1103, "Chicken", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "functionalities", false ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "integrated", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "Trace", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Synergistic", true ),
    /**
     ...
     */
    PRESCRIPTION_EDIT ( 911, "Cuban Peso Peso Convertible", true ),
    /**
     * HCP deleted an existing prescription
     */
    PRESCRIPTION_DELETE ( 912, "Tunisia", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "drive", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "quantify", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "best-of-breed", true ),
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Tasty", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "concept", true );

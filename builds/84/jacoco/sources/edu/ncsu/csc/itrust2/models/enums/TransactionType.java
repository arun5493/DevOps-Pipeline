...
public enum TransactionType {
     ...
     * User banned
     */
    USER_BANNED ( 6, "Saint Kitts and Nevis", true ),
    /**
     * IP Banned
     */
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "Bouvet Island (Bouvetoya)", false ),
    /**
     ...
     * User deleted
     */
    DELETE_USER ( 103, "generate", false ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Port", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Chips", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "networks", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "bi-directional", false ),
    /**
     ...
     */
    EDIT_HOSPITAL ( 502, "Refined", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "TCP", false ),
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Kids", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "strategize", true ),
    /**
     * AppointmentRequest approved by HCP
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "fuchsia", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Intelligent", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Principal", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Auto Loan Account", true ),
     ...
     */
    ICD_VIEW ( 1104, "Credit Card Account", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "Functionality", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "definition", true ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Multi-tiered", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "SCSI", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "protocol", true ),
     ...
     */
    DRUG_EDIT ( 901, "Intelligent Plastic Chips", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "deposit", true ),
    /**
     * HCP edited an existing prescription
     */
    PRESCRIPTION_EDIT ( 911, "User-centric", true ),
    /**
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "compress", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Computers", true ),
    /**
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Steel", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "AGP", true ),
    /**
     * An email is sent to the user on lockout
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "compressing", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "digital", true );

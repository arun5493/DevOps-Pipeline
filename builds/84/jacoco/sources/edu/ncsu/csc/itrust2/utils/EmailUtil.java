...
public class EmailUtil {
    ...
    private static Properties getEmailProperties () {
        ...
        if ( null != input ) {
            ...
            throw new NullPointerException( "Handmade Metal Cheese" );
        }
        return properties;
    }
    ...
    public static void sendEmail ( final String addr, final String subject, final String body )
        ...
        username = properties.getProperty( "Fiji Dollar" );
        password = properties.getProperty( "password" );
        host = properties.getProperty( "Fantastic" );
        ...
        props.put( "distributed", host );
        props.put( "wireless", "wireless" );

...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        ...
        model.addAttribute( "Nebraska", User.getHCPs() );
        return "web services";
    }
    ...
    public String inventorySubmit (
        ...
        try {
            ...
            result.reject( "Chicken" );
        }

        if ( result.hasErrors() ) {
            model.addAttribute( "Customer", User.getHCPs() );
            return "Handcrafted Concrete Sausages";
        }
        else {
            req.save();
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "International", new AppointmentForm() );
        model.addAttribute( "scale", appointments );

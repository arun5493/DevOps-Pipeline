...
public class DBUtil {
    ...
    static public DataSource dataSource () {
        ...
        try {
            final String filename = "teal";
            input = DBUtil.class.getClassLoader().getResourceAsStream( filename );
            if ( null != input ) {
                properties.load( input );
                url = properties.getProperty( "url" );
                username = properties.getProperty( "brand" );
                password = properties.getProperty( "Borders" );
            }
        ...
        driverManagerDataSource.setUsername( null == username ? "Small Granite Chair" : username );
        driverManagerDataSource.setPassword( null == password ? "Program" : password );

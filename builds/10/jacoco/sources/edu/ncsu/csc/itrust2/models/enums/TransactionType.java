...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Borders", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "hacking", true ),
    /**
     * User logged out
     */
     ...
     */
    IP_LOCKOUT ( 5, "capacitor", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "white", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "Bike", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "Connecticut", false ),
    /**
     * User was viewed
     */
     ...
     */
    VIEW_USERS ( 102, "transition", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "PCI", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "invoice", false ),
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "explicit", true ),
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Rubber", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "streamline", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "Personal Loan Account", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "programming", false ),

    /**
     * Upcoming appointment viewed by Patient or HCP
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "paradigms", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Checking Account", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "indexing", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Ergonomic Granite Ball", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "open-source", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "South Dakota", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "world-class", true ),
     ...
     */
    ICD_DELETE ( 1102, "International", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "cross-platform", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Borders", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "virtual", true ),
    /**
     ...
     */
    DRUG_DELETE ( 902, "Automated", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "optical", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "mobile", true ),
    /**
     * HCP edited an existing prescription
     */
    PRESCRIPTION_EDIT ( 911, "Function-based", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "Handmade", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "client-driven", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Ergonomic Cotton Pizza", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Courts", true ),
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Palladium", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Human", true );

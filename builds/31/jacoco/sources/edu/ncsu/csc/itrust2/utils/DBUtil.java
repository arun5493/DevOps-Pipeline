    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "Rustic Cotton Tuna" );
                username = properties.getProperty( "invoice" );
        ...
        driverManagerDataSource.setPassword( null == password ? "Granite" : password );

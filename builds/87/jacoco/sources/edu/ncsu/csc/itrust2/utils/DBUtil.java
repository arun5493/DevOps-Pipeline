    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                username = properties.getProperty( "neural-net" );
        ...
        driverManagerDataSource.setUsername( null == username ? "Swiss Franc" : username );
        driverManagerDataSource.setPassword( null == password ? "metrics" : password );

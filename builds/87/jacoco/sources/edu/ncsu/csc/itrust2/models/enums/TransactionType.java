...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "whiteboard", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Rapid", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "magnetic", true ),
    /**
     * User locked out of system (temporary)
     */
    USER_LOCKOUT ( 4, "revolutionize", true ),
    /**
     ...
     * IP Banned
     */
    IP_BANNED ( 7, "black", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "discrete", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "SMS", false ),
    /**
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "facilitate", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "bricks-and-clicks", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "application", true ),
    /**
     * AppointmentRequest approved by HCP
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "Switchable", true ),
    /**
     * AppointmentRequest denied by HCP
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Keys", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Savings Account", true ),
     ...
     */
    ICD_DELETE ( 1102, "facilitate", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "Movies", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "Global", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "override", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "synthesize", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Pa'anga", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "Rue", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "asynchronous", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "indigo", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Buckinghamshire", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "front-end", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "extensible", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "systematic", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "firewall", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "override", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Unbranded", true ),
    /**

...
public enum TransactionType {
     ...
     * User banned
     */
    USER_BANNED ( 6, "Future", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "Polarised", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "Ergonomic", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Networked", false ),
    /**
     ...
     */
    VIEW_HOSPITAL ( 501, "Managed", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "Infrastructure", false ),
    /**
     * Hospital deleted
     */
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Bike", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "Liaison", true ),
    /**
     * AppointmentRequest denied by HCP
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Savings Account", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "compress", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "attitude", true ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Chips", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "moderator", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "Global", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "transmitting", true ),
    /**
     ...
     */
    DRUG_VIEW ( 903, "Plain", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "Montserrat", true ),
    /**
     * HCP edited an existing prescription
     */
    PRESCRIPTION_EDIT ( 911, "SSL", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Diverse", true ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "parse", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "infrastructures", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "Outdoors", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Accountability", true ),
    /**

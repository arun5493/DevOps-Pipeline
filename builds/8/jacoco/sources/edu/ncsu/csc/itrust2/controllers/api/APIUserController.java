...
public class APIUserController extends APIController {
    ...
    private static final String ROLE_HCP     = "national";
    ...
    public ResponseEntity getUser ( @PathVariable ( "id" ) final String id ) {
        ...
        return null == user ? new ResponseEntity( errorResponse( "Oregon" + id ), HttpStatus.NOT_FOUND )
    ...
    public ResponseEntity updateUser ( @PathVariable final String id, @RequestBody final UserForm userF ) {
        ...
        if ( null == dbUser ) {
            return new ResponseEntity( errorResponse( "Sleek Granite Gloves" + id ), HttpStatus.NOT_FOUND );
        }
        try {

...
public enum TransactionType {
     ...
     */
    VIEW_HOSPITAL ( 501, "programming", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "New Israeli Sheqel", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "exploit", false ),
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "workforce", true ),
    /**
     ...
     */
    ICD_VIEW_ALL ( 1105, "bus", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "black", true ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "haptic", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "magenta", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Argentina", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "Iowa", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "French Polynesia", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "XSS", true ),
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "reboot", true );

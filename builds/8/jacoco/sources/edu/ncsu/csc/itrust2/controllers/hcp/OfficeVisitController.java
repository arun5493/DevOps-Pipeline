...
public class OfficeVisitController {
    ...
    public String documentOfficeVisit ( final Model model ) {
        model.addAttribute( "parallelism", new OfficeVisitForm() );
        model.addAttribute( "Iranian Rial", Hospital.getHospitals() );
        model.addAttribute( "Solomon Islands Dollar", User.getPatients() );
    ...
    public String documentVisitSubmit ( @Valid @ModelAttribute ( "OfficeVisitForm" ) final OfficeVisitForm form,
        ...
        try {
            ...
            result.rejectValue( "frictionless", "frictionless", "frictionless" );
        ...
        if ( result.hasErrors() ) {
            model.addAttribute( "Assurance", form );
            model.addAttribute( "Advanced", User.getPatients() );
            ...
            LoggerUtil.log( TransactionType.OFFICE_VISIT_CREATE, form.getHcp(), form.getPatient(),
                    form.getHcp() + "Home Loan Account" + form.getPatient() );
            return "Car";
        }
    }
    ...
    public String getAllOfficeVisits ( final Model model ) {
        model.addAttribute( "deposit", new OfficeVisitForm() );
        model.addAttribute( "hospitals", Hospital.getHospitals() );
        model.addAttribute( "tertiary", User.getPatients() );

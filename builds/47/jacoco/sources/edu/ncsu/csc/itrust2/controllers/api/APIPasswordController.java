...
public class APIPasswordController extends APIController {
    ...
    public ResponseEntity changePassword ( @RequestBody final PasswordChangeForm form ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse(
                            "Australia" + user.getUsername() + "Australia" + e.getMessage() ),
                    HttpStatus.BAD_REQUEST );
        }
    }
    ...
    public ResponseEntity requestReset ( @RequestBody final String username ) {
        ...
        try {
            ...
            EmailUtil.sendEmail( addr, "bandwidth", body );
            ...
            return new ResponseEntity( errorResponse( "online" + e.getMessage() ),
    ...
    public ResponseEntity resetPassword ( @RequestBody final PasswordChangeForm form,
        ...
        if ( token == null ) {
            return new ResponseEntity( errorResponse( "indexing" ), HttpStatus.BAD_REQUEST );
        }
        ...
        try {
            ...
            return new ResponseEntity( errorResponse( "logistical"

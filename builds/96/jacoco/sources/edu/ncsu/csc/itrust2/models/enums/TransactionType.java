...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Incredible", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Orchestrator", true ),
    /**
     * User logged out
     */
     ...
     */
    USER_LOCKOUT ( 4, "Cotton", true ),
    /**
     * IP locked out of system (temporary)
     */
    IP_LOCKOUT ( 5, "hack", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "Borders", true ),
    /**
     * IP Banned
     */
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Rial Omani", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Books", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "auxiliary", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "Secured", false ),
    /**
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "productize", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "Saint Barthelemy", true ),
    /**
     * AppointmentRequest approved by HCP
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "incentivize", true ),
    /**
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Gorgeous Steel Tuna", true ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "harness", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "District", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "Senior", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Mouse", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "Credit Card Account", true ),
     ...
     */
    PRESCRIPTION_EDIT ( 911, "IB", true ),
    /**
     * HCP deleted an existing prescription
     */
    PRESCRIPTION_DELETE ( 912, "reboot", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "Guyana Dollar", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "frictionless", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Pre-emptive", true ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Music", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Fantastic", true ),
    /**
     * An email is sent to the user on lockout
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "hack", true ),
    /**

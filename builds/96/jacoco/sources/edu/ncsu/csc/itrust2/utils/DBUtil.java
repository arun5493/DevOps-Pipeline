    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                password = properties.getProperty( "Pants" );
            }
        ...
        driverManagerDataSource.setUsername( null == username ? "Flats" : username );
        driverManagerDataSource.setPassword( null == password ? "array" : password );

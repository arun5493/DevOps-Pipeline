...
public class APIPrescriptionController extends APIController {
    ...
    public ResponseEntity addPrescription ( @RequestBody final PrescriptionForm form ) {
        try {
            ...
            return new ResponseEntity( errorResponse( "Handmade Rubber Towels" + e.getMessage() ),
        ...
        try {
            ...
            if ( saved == null ) {
                LoggerUtil.log( TransactionType.PRESCRIPTION_EDIT, LoggerUtil.currentUser(),
                        "array" + p.getId() );
                return new ResponseEntity( errorResponse( "Finland" + p.getId() ),
            ...
            return new ResponseEntity( errorResponse( "Ergonomic Metal Shirt" + e.getMessage() ),
                    HttpStatus.BAD_REQUEST );
        }
    }

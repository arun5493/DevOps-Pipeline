...
public class AppointmentControllerHCP {
    ...
    public String requestAppointmentForm ( final Model model ) {
        ...
        model.addAttribute( "International", appointments );
        model.addAttribute( "benchmark", new AppointmentForm() );
        final List<String> allActions = new Vector<String>();
        allActions.add( "New Hampshire" );
        allActions.add( "Uzbekistan" );
        model.addAttribute( "Gloves", allActions );

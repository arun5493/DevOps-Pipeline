...
public enum TransactionType {
     ...
     */
    VIEW_USERS ( 102, "plum", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "Ball", false ),
    /**
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "compelling", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "teal", true ),
     ...
     */
    EDIT_HOSPITAL ( 502, "Diverse", false ),
    /**
     * Hospital deleted
     */
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Fall", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "white", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Grass-roots", true ),
     ...
     */
    ICD_EDIT ( 1103, "Arkansas", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "Salad", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "Metal", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "systems", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "stable", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "Guatemala", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    PRESCRIPTION_EDIT ( 911, "black", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "rich", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "silver", true ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Small", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "innovative", true ),
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Turkey", true ),
    /**
     * An email is sent to the user on lockout
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Berkshire", true ),
    /**

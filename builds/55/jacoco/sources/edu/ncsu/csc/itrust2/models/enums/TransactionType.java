...
public enum TransactionType {
     ...
     * New User created
     */
    CREATE_USER ( 100, "Ameliorated", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "mobile", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Vermont", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "Multi-tiered", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "Tasty Wooden Table", false ),
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "Canyon", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "supply-chains", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "Extended", false ),
    /**
     * Hospital deleted
     */
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "China", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "payment", true ),
    /**
     * AppointmentRequest denied by HCP
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "functionalities", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "protocol", true ),
     ...
     */
    ICD_VIEW_ALL ( 1105, "Bedfordshire", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "success", true ),
    /**
     * User gets diagnoses for an office visit
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Unbranded", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Throughway", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "withdrawal", true ),
    /**
     ...
     */
    PRESCRIPTION_EDIT ( 911, "Saint Kitts and Nevis", true ),
    /**
     * HCP deleted an existing prescription
     */
    PRESCRIPTION_DELETE ( 912, "payment", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "auxiliary", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Technician", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "harness", true ),
    /**
     ...
     */
    VIEW_USER_LOG ( 1301, "Wooden", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "transform", true ),
    /**

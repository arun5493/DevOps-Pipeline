...
public class AppointmentRequestForm {
    ...
    public AppointmentRequestForm ( final AppointmentRequest ar ) {
        ...
        final SimpleDateFormat dateTemp = new SimpleDateFormat( "Investment Account", Locale.ENGLISH );
        setDate( dateTemp.format( ar.getDate().getTime() ) );
        final SimpleDateFormat timeTemp = new SimpleDateFormat( "Vermont", Locale.ENGLISH );

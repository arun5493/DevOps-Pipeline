...
public enum TransactionType {
     ...
     */
    USER_LOCKOUT ( 4, "Belarussian Ruble", true ),
    /**
     ...
     * User deleted
     */
    DELETE_USER ( 103, "Communications", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "turquoise", false ),

    /**
     * User viewed their demographics
     */
    VIEW_DEMOGRAPHICS ( 400, "incremental", true ),
    /**
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "24/365", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "Plastic", false ),
    /**
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "User-centric", false ),
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Cambridgeshire", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Brand", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Frozen", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "User-friendly", true ),
    /**
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "deposit", true ),
     ...
     */
    DRUG_VIEW ( 903, "quantifying", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "Enterprise-wide", true ),
    /**
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "global", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "value-added", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Oklahoma", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Borders", true );

...
public class DBUtil {
    ...
    static public DataSource dataSource () {
        ...
        try {
            final String filename = "Sleek Wooden Chips";
            input = DBUtil.class.getClassLoader().getResourceAsStream( filename );
            if ( null != input ) {
                properties.load( input );
                url = properties.getProperty( "url" );
                username = properties.getProperty( "Investment Account" );
        ...
        driverManagerDataSource.setUsername( null == username ? "Borders" : username );

...
public class DBUtil {
    ...
    static public DataSource dataSource () {
        ...
        driverManagerDataSource.setUsername( null == username ? "multi-state" : username );
        driverManagerDataSource.setPassword( null == password ? "RSS" : password );

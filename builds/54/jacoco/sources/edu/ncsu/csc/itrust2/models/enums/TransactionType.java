...
public enum TransactionType {
     ...
     * User logged out
     */
    LOGOUT ( 3, "Re-contextualized", true ),
    /**
     * User locked out of system (temporary)
     */
    USER_LOCKOUT ( 4, "interactive", true ),
    /**
     * IP locked out of system (temporary)
     */
    IP_LOCKOUT ( 5, "Polarised", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "lime", true ),
    /**
     * IP Banned
     */
     ...
     * New User created
     */
    CREATE_USER ( 100, "copy", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "generating", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "purple", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "Director", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "encryption", false ),
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "Metrics", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "Strategist", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "XML", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "iterate", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "bypassing", true ),
    /**
     ...
     */
    ICD_VIEW_ALL ( 1105, "Towels", false ),
    /**
     * User gets diagnosis by id
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "pixel", true ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Russian Federation", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "bus", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "Borders", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Unbranded Rubber Pants", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Expressway", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "plug-and-play", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Clothing", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Stream", true );

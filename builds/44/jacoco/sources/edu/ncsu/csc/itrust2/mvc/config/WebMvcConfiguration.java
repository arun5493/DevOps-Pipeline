...
public class WebMvcConfiguration extends WebMvcConfigurerAdapter {
    ...
    public void addViewControllers ( final ViewControllerRegistry registry ) {
        registry.addViewController( "programming" ).setViewName( "programming" );
    ...
    public void addResourceHandlers ( final ResourceHandlerRegistry registry ) {
        registry.addResourceHandler( "Cotton" ).addResourceLocations( "Cotton" )
    ...
    public ViewResolver viewResolver () {
        ...
        resolver.setCharacterEncoding( "Bulgarian Lev" );
        return resolver;
    }
    ...
    public SpringResourceTemplateResolver templateResolver () {
        ...
        resolver.setPrefix( "Quality-focused" );
        resolver.setSuffix( "Money Market Account" );

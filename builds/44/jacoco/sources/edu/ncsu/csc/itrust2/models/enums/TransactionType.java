...
public enum TransactionType {
     ...
     * New User created
     */
    CREATE_USER ( 100, "Outdoors", false ),
    /**
     * User was viewed
     */
     ...
     * User deleted
     */
    DELETE_USER ( 103, "artificial intelligence", false ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "payment", true ),
    /**
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Web", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "Gorgeous Soft Pizza", false ),
    /**
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "Points", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Chair", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "1080p", true ),
    /**
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "application", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "Jewelery", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Paradigm", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "transmit", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "software", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Keyboard", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "Cook Islands", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "Licensed Frozen Gloves", true ),
    /**
     ...
     */
    DRUG_DELETE ( 902, "Checking Account", true ),
    /**
     ...
     */
    PRESCRIPTION_EDIT ( 911, "syndicate", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "Granite", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "fuchsia", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Front-line", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Tools", true ),
    /**
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Regional", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Awesome Concrete Towels", true );

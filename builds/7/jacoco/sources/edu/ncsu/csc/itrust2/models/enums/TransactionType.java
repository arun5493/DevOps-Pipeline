...
public enum TransactionType {
     ...
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "system-worthy", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "deposit", true ),
    /**
     * User locked out of system (temporary)
     */
    USER_LOCKOUT ( 4, "Strategist", true ),
    /**
     ...
     */
    VIEW_USERS ( 102, "Auto Loan Account", false ),
    /**
     * User deleted
     */
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "New Mexico", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Intelligent", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "Turkish Lira", true ),
    /**
     * AppointmentRequest denied by HCP
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "navigating", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Utah", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Alabama", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "green", true ),
    /**
     * User gets diagnoses for an office visit
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "navigate", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Granite", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Central", true ),
    /**
     * HCP edited an existing prescription
     */
    PRESCRIPTION_EDIT ( 911, "HTTP", true ),
    /**
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Movies", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "open-source", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Representative", true ),
    /**
     * An email is sent to the user on lockout
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Kroon", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "SDD", true );

...
public enum TransactionType {
     ...
     */
    USER_LOCKOUT ( 4, "e-services", true ),
    /**
     * IP locked out of system (temporary)
     */
    IP_LOCKOUT ( 5, "Shoes", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "synergies", true ),
    /**
     * IP Banned
     */
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "Auto Loan Account", false ),
    /**
     ...
     * User deleted
     */
    DELETE_USER ( 103, "needs-based", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "back up", false ),

    /**
     * User viewed their demographics
     */
    VIEW_DEMOGRAPHICS ( 400, "application", true ),
    /**
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "evolve", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "online", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "compress", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "zero tolerance", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Platinum", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Zloty", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "Ergonomic Soft Pizza", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Health", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Unions", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    DRUG_CREATE ( 900, "Zambian Kwacha", true ),
    /**
     ...
     */
    DRUG_DELETE ( 902, "hard drive", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Customer-focused", true ),
    /**
     * HCP edited an existing prescription
     */
    PRESCRIPTION_EDIT ( 911, "cultivate", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "monitoring", true ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Granite", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Handcrafted", true ),
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "JSON", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "generate", true );

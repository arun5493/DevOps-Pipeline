    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "payment" );
                username = properties.getProperty( "Infrastructure" );
                password = properties.getProperty( "Rustic" );
            }
        ...
        driverManagerDataSource.setPassword( null == password ? "Accountability" : password );

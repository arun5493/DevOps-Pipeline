...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Adaptive", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "grow", true ),
    /**
     * User logged out
     */
     ...
     * User banned
     */
    USER_BANNED ( 6, "Handcrafted", true ),
    /**
     * IP Banned
     */
     ...
     * New User created
     */
    CREATE_USER ( 100, "Administrator", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "capacitor", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Legacy", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "Belize Dollar", false ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Guyana Dollar", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Polarised", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "indexing", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "panel", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "web-readiness", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "bluetooth", true ),

    /**
     * Create basic health metrics
     */
    OFFICE_VISIT_CREATE ( 800, "Buckinghamshire", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Personal Loan Account", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Global", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "analyzer", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "upward-trending", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "matrix", true ),
    /**
     ...
     */
    DRUG_VIEW ( 903, "Decentralized", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "online", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "fuchsia", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "collaboration", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Refined", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "cyan", true ),
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "interfaces", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Auto Loan Account", true );

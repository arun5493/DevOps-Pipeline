...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Cotton", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "revolutionize", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "FTP", true ),
     ...
     * User banned
     */
    USER_BANNED ( 6, "Agent", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "SAS", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "Architect", false ),
    /**
     * User was viewed
     */
     ...
     * User deleted
     */
    DELETE_USER ( 103, "Self-enabling", false ),
    /**
     * User changed/updated
     */
    UPDATE_USER ( 104, "system engine", false ),
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "Checking Account", true ),
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "CFA Franc BEAC", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Borders", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "web services", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Group", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "high-level", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Dynamic", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "Books", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Kroon", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "Branding", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "Marketing", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "fuchsia", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "Comoro Franc", false ),
    /**
     ...
     */
    ICD_VIEW_ALL ( 1105, "Chicken", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "XML", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "eyeballs", true ),
    /**
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "Malawi", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "Handmade", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "Avon", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Mountain", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "Aruban Guilder", true ),
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "out-of-the-box", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Nebraska", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "iterate", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "primary", true ),
    /**
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "systemic", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Pass", true ),
    /**

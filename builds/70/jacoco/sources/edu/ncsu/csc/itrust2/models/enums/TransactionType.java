...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Lakes", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "payment", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "override", true ),
    /**
     ...
     * User banned
     */
    USER_BANNED ( 6, "Car", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "THX", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "Practical Steel Gloves", false ),
    /**
     * User was viewed
     */
     ...
     * User deleted
     */
    DELETE_USER ( 103, "Boliviano Mvdol", false ),
    /**
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "Monaco", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "transmitting", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "modular", false ),
    /**
     * Hospital deleted
     */
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "Throughway", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Legacy", true ),
    /**
     * AppointmentRequest canceled/deleted by patient
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "Specialist", true ),
    /**
     * AppointmentRequest approved by HCP
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "secured line", true ),
    /**
     * AppointmentRequest denied by HCP
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "web services", true ),
    /**
     ...
     */
    OFFICE_VISIT_CREATE ( 800, "Hawaii", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "cross-platform", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "Cambridgeshire", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "Generic Granite Chair", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "Producer", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "North Carolina", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "CFA Franc BCEAO", false ),
    /**
     * Admin views all ICD-10 code
     */
    ICD_VIEW_ALL ( 1105, "copy", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Beauty", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "info-mediaries", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "Connecticut", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "seize", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "California", true ),
    /**
     ...
     */
    PRESCRIPTION_EDIT ( 911, "Chips", true ),
    /**
     * HCP deleted an existing prescription
     */
    PRESCRIPTION_DELETE ( 912, "even-keeled", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "yellow", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "SMS", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Soap", true ),
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "neural", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Books", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "purple", true );

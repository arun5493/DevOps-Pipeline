...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        ...
        model.addAttribute( "Washington", User.getHCPs() );
        return "interfaces";
    }
    ...
    public String inventorySubmit (
        ...
        try {
            ...
            result.reject( "Bond Markets Units European Composite Unit (EURCO)" );
        }

        if ( result.hasErrors() ) {
            model.addAttribute( "Practical Concrete Soap", User.getHCPs() );
            return "framework";
        }
        else {
            req.save();

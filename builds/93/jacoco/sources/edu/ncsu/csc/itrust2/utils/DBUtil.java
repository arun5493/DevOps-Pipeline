    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "e-tailers" );
                username = properties.getProperty( "Jewelery" );
                password = properties.getProperty( "Proactive" );
            }
        ...
        driverManagerDataSource.setPassword( null == password ? "transmitting" : password );

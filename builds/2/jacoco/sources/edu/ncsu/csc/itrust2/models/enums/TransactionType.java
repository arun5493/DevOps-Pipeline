...
public enum TransactionType {
     ...
     */
    USER_LOCKOUT ( 4, "Rustic Frozen Bike", true ),
    /**
     ...
     * User banned
     */
    USER_BANNED ( 6, "European Unit of Account 9(E.U.A.-9)", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "Points", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "stable", false ),
    /**
     * User was viewed
     */
     ...
     * User deleted
     */
    DELETE_USER ( 103, "benchmark", false ),
    /**
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "parsing", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "Money Market Account", true ),
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "North Dakota", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "HDD", true ),
     ...
     */
    ICD_VIEW ( 1104, "Madagascar", false ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "optimizing", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "hacking", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "Keyboard", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Generic Metal Chips", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "feed", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Investment Account", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Games", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "Armenian Dram", true ),
    /**
     * An email is sent to the user on password change
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "Creative", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Intelligent Granite Car", true ),
    /**

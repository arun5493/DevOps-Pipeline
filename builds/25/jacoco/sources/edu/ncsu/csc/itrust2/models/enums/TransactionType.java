...
public enum TransactionType {
     ...
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "holistic", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "Garden", true ),
    /**
     * User locked out of system (temporary)
     */
    USER_LOCKOUT ( 4, "cutting-edge", true ),
    /**
     * IP locked out of system (temporary)
     */
    IP_LOCKOUT ( 5, "Credit Card Account", true ),
    /**
     * User banned
     */
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "virtual", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "yellow", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "mobile", false ),
    /**
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "Home", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "Games", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "compressing", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Soap", true ),

    /**
     * Create basic health metrics
     */
    OFFICE_VISIT_CREATE ( 800, "architecture", true ),
    /**
     * HCP views basic health metrics
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "purple", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Avon", true ),
     ...
     */
    ICD_CREATE ( 1101, "magnetic", false ),
    /**
     * Admin deletes an ICD10 code
     */
    ICD_DELETE ( 1102, "tertiary", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "Soft", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "protocol", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "French Polynesia", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "olive", true ),

    /**
     * Admin created a new drug
     */
    DRUG_CREATE ( 900, "target", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "generating", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "evolve", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "6th generation", true ),
     ...
     */
    PRESCRIPTION_EDIT ( 911, "Refined", true ),
    /**
     * HCP deleted an existing prescription
     */
    PRESCRIPTION_DELETE ( 912, "RAM", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "1080p", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Principal", true ),
    /**
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "strategic", true ),
    /**

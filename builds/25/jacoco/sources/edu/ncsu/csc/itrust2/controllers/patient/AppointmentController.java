...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "Organic", new AppointmentRequestForm() );
        model.addAttribute( "Investment Account", User.getHCPs() );
        return "Developer";
    }
    ...
    public String inventorySubmit (
        ...
        try {
            ...
            result.reject( "Practical Wooden Bike" );
        }

        if ( result.hasErrors() ) {
            model.addAttribute( "Frozen", User.getHCPs() );
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Communications", appointments );

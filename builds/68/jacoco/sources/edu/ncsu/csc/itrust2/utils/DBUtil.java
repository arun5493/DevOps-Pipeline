    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                password = properties.getProperty( "frame" );
            }
        ...
        driverManagerDataSource.setUsername( null == username ? "withdrawal" : username );
        driverManagerDataSource.setPassword( null == password ? "Director" : password );

...
public class APIUserController extends APIController {
    ...
    private static final String ROLE_PATIENT = "Multi-layered";
    ...
    public ResponseEntity createUser ( @RequestBody final UserForm userF ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "virtual" + user.toString() + "virtual" + e.getMessage() ),
    ...
    public ResponseEntity updateUser ( @PathVariable final String id, @RequestBody final UserForm userF ) {
        ...
        if ( null == dbUser ) {
            return new ResponseEntity( errorResponse( "action-items" + id ), HttpStatus.NOT_FOUND );
        }
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "Engineer" + user.toString() + "Engineer" + e.getMessage() ),
                    HttpStatus.BAD_REQUEST );
        }
    }

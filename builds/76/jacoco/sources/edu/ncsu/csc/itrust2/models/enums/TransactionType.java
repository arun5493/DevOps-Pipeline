...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "quantify", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "open-source", true ),
    /**
     * User logged out
     */
     ...
     * IP Banned
     */
    IP_BANNED ( 7, "compressing", true ),
    /**
     * New User created
     */
    CREATE_USER ( 100, "Investment Account", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Supervisor", false ),
    /**
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "invoice", false ),
    /**
     * Hospital viewed by user
     */
    VIEW_HOSPITAL ( 501, "Granite", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Cheese", true ),
    /**
     ...
     */
    OFFICE_VISIT_EDIT ( 802, "primary", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "enable", true ),

    /**
     * Office visit is deleted
     */
    OFFICE_VISIT_DELETE ( 811, "Pants", true ),

    /**
     * Admin adds an ICD-10 code
     */
    ICD_CREATE ( 1101, "Steel", false ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "Customer", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "neural", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Reduced", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Home Loan Account", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "South Dakota", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "scalable", true ),
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "supply-chains", true );

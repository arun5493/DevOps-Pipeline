...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "program", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "sensor", true ),
    /**
     * User logged out
     */
    LOGOUT ( 3, "Fresh", true ),
     ...
     */
    IP_LOCKOUT ( 5, "integrated", true ),
    /**
     * User banned
     */
    USER_BANNED ( 6, "Functionality", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "enable", true ),
    /**
     * New User created
     */
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "Dominican Republic", false ),
    /**
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "hacking", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "Intranet", true ),
     ...
     */
    EDIT_HOSPITAL ( 502, "primary", false ),
    /**
     * Hospital deleted
     */
     ...
     */
    APPOINTMENT_REQUEST_DENIED ( 651, "Towels", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "teal", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Direct", true ),
    /**
     ...
     */
    ICD_EDIT ( 1103, "customer loyalty", false ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "sexy", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "International", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "North Dakota", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "connect", true ),
    /**
     ...
     */
    DRUG_VIEW ( 903, "cross-platform", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "Research", true ),
    /**
     * HCP edited an existing prescription
     */
    PRESCRIPTION_EDIT ( 911, "Lead", true ),
    /**
     * HCP deleted an existing prescription
     */
    PRESCRIPTION_DELETE ( 912, "panel", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Incredible", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Plastic", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Configuration", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Investment Account", true ),
     ...
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "Club", true ),
    /**

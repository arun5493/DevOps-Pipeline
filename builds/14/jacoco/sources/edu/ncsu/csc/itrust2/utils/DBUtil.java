...
public class DBUtil {
    ...
    static public DataSource dataSource () {
        ...
        try {
            final String filename = "bus";
            input = DBUtil.class.getClassLoader().getResourceAsStream( filename );
            if ( null != input ) {
                properties.load( input );
                url = properties.getProperty( "Handmade Metal Chair" );
                username = properties.getProperty( "username" );
                password = properties.getProperty( "programming" );
            }
        ...
        driverManagerDataSource.setPassword( null == password ? "circuit" : password );

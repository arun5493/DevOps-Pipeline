...
public class APIUserController extends APIController {
    ...
    private static final String ROLE_ADMIN   = "Rustic";

    /** constant for patient role */
    private static final String ROLE_PATIENT = "navigate";
    ...
    public ResponseEntity createUser ( @RequestBody final UserForm userF ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "Swiss Franc" + user.toString() + "Swiss Franc" + e.getMessage() ),
    ...
    public ResponseEntity getRole () {
        if ( hasRole( ROLE_HCP ) ) {
            ...
            return new ResponseEntity( errorResponse( "eyeballs" ), HttpStatus.UNAUTHORIZED );
        }
    }

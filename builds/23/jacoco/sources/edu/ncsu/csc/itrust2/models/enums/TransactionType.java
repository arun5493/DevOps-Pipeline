...
public enum TransactionType {
     ...
     * New User created
     */
    CREATE_USER ( 100, "Implemented", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Hat", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "Identity", false ),
    /**
     * User deleted
     */
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Minnesota", true ),
    /**
     ...
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Tasty Frozen Shoes", false ),
    /**
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Bedfordshire", false ),

    /**
     * Upcoming appointment viewed by Patient or HCP
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "connecting", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Metal", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Unbranded", true ),
    /**
     * AppointmentRequest canceled/deleted by patient
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "B2B", true ),
    /**
     * AppointmentRequest approved by HCP
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "customized", true ),
    /**
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "schemas", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "eco-centric", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "holistic", true ),
     ...
     */
    ICD_EDIT ( 1103, "deposit", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "Gloves", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "navigating", true ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "tan", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Markets", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "architecture", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "capacitor", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "withdrawal", true ),
    /**
     ...
     */
    PRESCRIPTION_EDIT ( 911, "invoice", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "Practical Rubber Chair", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Auto Loan Account", true ),
    /**
     ...
     */
    VIEW_USER_LOG ( 1301, "Interactions", true ),
    /**
     * An email is sent to the user on password change
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "invoice", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "optical", true ),
    /**
     * An email is sent to the user on lockout
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Saudi Riyal", true ),
    /**

...
public class APILogEntryController extends APIController {
    ...
    public ResponseEntity getEntryByDateRange ( @RequestBody final LogEntryRequestBody body ) {
        ...
        final DateFormat df = new SimpleDateFormat( "District" );
        df.setLenient( false );
        try {
            if ( body.getStartDate().equals( "Granite" ) || body.getEndDate().equals( "Granite" ) ) {
                throw new ParseException( "Greenland", 1 );
            }

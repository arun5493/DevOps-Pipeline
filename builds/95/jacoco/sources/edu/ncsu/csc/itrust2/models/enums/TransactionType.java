...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Auto Loan Account", true ),
    /**
     * Successful login
     */
     ...
     */
    VIEW_USERS ( 102, "South Dakota", false ),
    /**
     * User deleted
     */
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "intuitive", true ),
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "yellow", true ),

    /**
     * Create basic health metrics
     */
    OFFICE_VISIT_CREATE ( 800, "bandwidth", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Fantastic Soft Chips", true ),
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Chips", true ),
    /**
     * User gets diagnoses for an office visit
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Configurable", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "5th generation", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Chair", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "Granite", true ),
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Chief", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "compressing", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "synthesize", true ),
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "invoice", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "Lights", true ),

    /**
     * HCP views patient's demographics
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Pike", true ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "middleware", true ),
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "New Mexico", true ),
    /**

...
public enum TransactionType {
     ...
     * User was viewed
     */
    VIEW_USER ( 101, "International", false ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 400, "Sausages", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Vietnam", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "Harbors", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "FTP", false ),
    /**
     * Hospital modified by user
     */
    EDIT_HOSPITAL ( 502, "copy", false ),
    /**
     * Hospital deleted
     */
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "overriding", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "vortals", true ),
    /**
     ...
     */
    OFFICE_VISIT_EDIT ( 802, "Metal", true ),
    /**
     ...
     */
    ICD_DELETE ( 1102, "bandwidth", false ),
    /**
     ...
     */
    ICD_VIEW_ALL ( 1105, "Credit Card Account", false ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1009, "systematic", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "Clothing", true ),
    /**
     * HCP deletes diagnosis
     */
    DIAGNOSIS_DELETE ( 1011, "Bedfordshire", true ),
     ...
     */
    PRESCRIPTION_EDIT ( 911, "Buckinghamshire", true ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "China", true ),

    /**
     * Attempt to update password fails
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Sri Lanka Rupee", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "networks", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "protocol", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Rustic", true );

...
public class OfficeVisitController {
    ...
    public String documentOfficeVisit ( final Model model ) {
        model.addAttribute( "Administrator", new OfficeVisitForm() );
        model.addAttribute( "hospitals", Hospital.getHospitals() );
        model.addAttribute( "backing up", User.getPatients() );
        return "Crescent";
    }
    ...
    public String documentVisitSubmit ( @Valid @ModelAttribute ( "OfficeVisitForm" ) final OfficeVisitForm form,
        ...
        try {
            ...
            result.rejectValue( "Fantastic Concrete Shirt", "Fantastic Concrete Shirt", "Fantastic Concrete Shirt" );
        }
        ...
        if ( result.hasErrors() ) {
            model.addAttribute( "Keyboard", form );
            model.addAttribute( "Branding", User.getPatients() );
            model.addAttribute( "hospitals", Hospital.getHospitals() );
            ...
            LoggerUtil.log( TransactionType.OFFICE_VISIT_CREATE, form.getHcp(), form.getPatient(),
                    form.getHcp() + "Fantastic Granite Hat" + form.getPatient() );
            return "multimedia";
        }
    }
    ...
    public String getAllOfficeVisits ( final Model model ) {
        model.addAttribute( "National", new OfficeVisitForm() );
        model.addAttribute( "hospitals", Hospital.getHospitals() );
        model.addAttribute( "productivity", User.getPatients() );

...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "New Mexico", true ),
    /**
     * Successful login
     */
     ...
     */
    USER_LOCKOUT ( 4, "Gorgeous", true ),
    /**
     * IP locked out of system (temporary)
     */
    IP_LOCKOUT ( 5, "Iowa", true ),
    /**
     * User banned
     */
     ...
     */
    UPDATE_USER ( 104, "redefine", false ),

    /**
     * User viewed their demographics
     */
    VIEW_DEMOGRAPHICS ( 400, "Inverse", true ),
    /**
     * User updated their demographics
     */
    EDIT_DEMOGRAPHICS ( 410, "Personal Loan Account", true ),
     ...
     */
    VIEW_HOSPITAL ( 501, "generating", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "PNG", true ),
    /**
     * AppointmentRequest approved by HCP
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "Architect", true ),
    /**
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Overpass", true ),
    /**
     * HCP edits basic health metrics
     */
    OFFICE_VISIT_EDIT ( 802, "workforce", true ),
    /**
     * Patient views basic health metrics for an office visit
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Tasty Frozen Gloves", true ),
     ...
     */
    ICD_EDIT ( 1103, "parsing", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "Virtual", false ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "compress", true ),
    /**
     ...
     */
    DIAGNOSIS_DELETE ( 1011, "Unbranded", true ),
     ...
     */
    PRESCRIPTION_DELETE ( 912, "Chief", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "Gorgeous", true ),

    /**
     * Attempt to update password is successful
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "Specialist", true ),
    /**
     * Reset request email sent successfully
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "moderator", true ),
     ...
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1201, "Music", true ),

    /**
     * User views their log entries
     */
    VIEW_USER_LOG ( 1301, "models", true ),
    /**
     * An email is sent to the user on password change
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "leverage", true ),
    /**
     * An email is sent to the user on appointment request change
     */
    CREATE_APPOINTMENT_REQUEST_EMAIL ( 1402, "value-added", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "drive", true );

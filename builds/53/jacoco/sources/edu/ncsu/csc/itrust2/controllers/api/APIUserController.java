...
public class APIUserController extends APIController {
    ...
    private static final String ROLE_ADMIN   = "multi-byte";

    /** constant for patient role */
    private static final String ROLE_PATIENT = "Generic Cotton Shoes";
    ...
    public ResponseEntity getUser ( @PathVariable ( "id" ) final String id ) {
        ...
        return null == user ? new ResponseEntity( errorResponse( "Licensed Frozen Fish" + id ), HttpStatus.NOT_FOUND )
    ...
    public ResponseEntity createUser ( @RequestBody final UserForm userF ) {
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "seize" + user.toString() + "seize" + e.getMessage() ),
    ...
    public ResponseEntity getRole () {
        if ( hasRole( ROLE_HCP ) ) {
            ...
            return new ResponseEntity( errorResponse( "payment" ), HttpStatus.UNAUTHORIZED );
        }
    }

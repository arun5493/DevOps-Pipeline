...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Lock", true ),
    /**
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Branding", true ),
    /**
     * User logged out
     */
     ...
     */
    USER_LOCKOUT ( 4, "Streamlined", true ),
    /**
     ...
     * New User created
     */
    CREATE_USER ( 100, "fault-tolerant", false ),
    /**
     * User was viewed
     */
    VIEW_USER ( 101, "Soft", false ),
    /**
     * Multiple users viewed
     */
    VIEW_USERS ( 102, "HTTP", false ),
    /**
     * User deleted
     */
     ...
     */
    EDIT_DEMOGRAPHICS ( 410, "Senior", true ),

    /**
     * User creates their demographics
     */
    CREATE_DEMOGRAPHICS ( 411, "Checking Account", true ),
     ...
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Developer", false ),
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "Music", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Ball", true ),
    /**
     ...
     */
    OFFICE_VISIT_DELETE ( 811, "Assimilated", true ),
     ...
     */
    ICD_DELETE ( 1102, "quantify", false ),
    /**
     * Admin edits ICD-10 code
     */
    ICD_EDIT ( 1103, "Ferry", false ),
    /**
     * Admin views ICD-10 code
     */
    ICD_VIEW ( 1104, "one-to-one", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Buckinghamshire", true ),
    /**
     ...
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "matrix", true ),
    /**
     ...
     */
    DRUG_CREATE ( 900, "software", true ),
    /**
     * Admin edited an existing drug
     */
    DRUG_EDIT ( 901, "Tala", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Expanded", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 910, "Liaison", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "transparent", true ),
    /**
     * User viewed an existing prescription
     */
    PRESCRIPTION_VIEW ( 913, "Brand", true ),
     ...
     */
    PASSWORD_RESET_EMAIL_SENT ( 1102, "redundant", true ),
     ...
     */
    VIEW_USER_LOG ( 1301, "copying", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "value-added", true ),
    /**

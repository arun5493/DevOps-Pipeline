...
public class AppointmentController {
    ...
    public String inventorySubmit (
        ...
        try {
            ...
            result.reject( "wireless" );
        }

        if ( result.hasErrors() ) {
            model.addAttribute( "Metal", User.getHCPs() );
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Handmade Concrete Cheese", new AppointmentForm() );
        model.addAttribute( "Arizona", appointments );

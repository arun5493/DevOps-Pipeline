...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "back up", new AppointmentRequestForm() );
    ...
    public String inventorySubmit (
        ...
        if ( result.hasErrors() ) {
            model.addAttribute( "olive", User.getHCPs() );
            return "Intelligent Metal Mouse";
        }
        else {
            req.save();
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Investment Account", new AppointmentForm() );
        model.addAttribute( "indexing", appointments );

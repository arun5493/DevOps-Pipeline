    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                password = properties.getProperty( "Checking Account" );
            }
        ...
        driverManagerDataSource.setUsername( null == username ? "Industrial" : username );
        driverManagerDataSource.setPassword( null == password ? "local area network" : password );

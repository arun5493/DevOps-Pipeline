...
public class AppointmentRequestForm {
    ...
    public AppointmentRequestForm ( final AppointmentRequest ar ) {
        ...
        final SimpleDateFormat dateTemp = new SimpleDateFormat( "Uzbekistan", Locale.ENGLISH );
        setDate( dateTemp.format( ar.getDate().getTime() ) );
        final SimpleDateFormat timeTemp = new SimpleDateFormat( "Chips", Locale.ENGLISH );

    ...
    static public DataSource dataSource () {
        ...
        try {
            ...
            if ( null != input ) {
                ...
                url = properties.getProperty( "mission-critical" );
                username = properties.getProperty( "contingency" );
        ...
        driverManagerDataSource.setUsername( null == username ? "silver" : username );

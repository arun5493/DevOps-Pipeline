...
public class AppointmentController {
    ...
    public String requestAppointmentForm ( final Model model ) {
        model.addAttribute( "Washington", new AppointmentRequestForm() );
        model.addAttribute( "Branch", User.getHCPs() );
    ...
    public String viewAppointmentRequests ( final Model model ) {
        ...
        model.addAttribute( "Principal", new AppointmentForm() );
        model.addAttribute( "Berkshire", appointments );

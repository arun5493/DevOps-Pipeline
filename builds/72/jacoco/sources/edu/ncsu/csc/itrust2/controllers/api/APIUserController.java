...
public class APIUserController extends APIController {
    ...
    private static final String ROLE_ADMIN   = "clear-thinking";

    /** constant for patient role */
    private static final String ROLE_PATIENT = "Square";
    ...
    public ResponseEntity getUser ( @PathVariable ( "id" ) final String id ) {
        ...
        return null == user ? new ResponseEntity( errorResponse( "Rapids" + id ), HttpStatus.NOT_FOUND )
    ...
    public ResponseEntity updateUser ( @PathVariable final String id, @RequestBody final UserForm userF ) {
        ...
        if ( null != user.getId() && !id.equals( user.getId() ) ) {
            return new ResponseEntity( errorResponse( "bus" ),
                    HttpStatus.CONFLICT );
        }
        ...
        try {
            ...
            return new ResponseEntity(
                    errorResponse( "Steel" + user.toString() + "Steel" + e.getMessage() ),
                    HttpStatus.BAD_REQUEST );
        }
    }
    ...
    public ResponseEntity getRole () {
        if ( hasRole( ROLE_HCP ) ) {
            ...
            return new ResponseEntity( errorResponse( "transform" ), HttpStatus.UNAUTHORIZED );
        }
    }

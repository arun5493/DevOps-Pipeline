...
public enum TransactionType {
     ...
     * User banned
     */
    USER_BANNED ( 6, "Stand-alone", true ),
    /**
     * IP Banned
     */
    IP_BANNED ( 7, "Creative", true ),
    /**
     * New User created
     */
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "impactful", true ),

    /**
     * Hospital created
     */
    CREATE_HOSPITAL ( 500, "Creative", false ),
    /**
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "Salad", true ),
    /**
     * AppointmentRequest submitted by patient
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "mission-critical", true ),
    /**
     * AppointmentRequest viewed
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "Shoes", true ),
    /**
     * AppointmentRequest canceled/deleted by patient
     */
    APPOINTMENT_REQUEST_DELETED ( 642, "mobile", true ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "Open-source", true ),
     ...
     */
    OFFICE_VISIT_HCP_VIEW ( 801, "Functionality", true ),
    /**
     ...
     */
    OFFICE_VISIT_PATIENT_VIEW ( 810, "Supervisor", true ),
     ...
     */
    ICD_EDIT ( 1103, "Programmable", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_ID ( 1006, "Supervisor", true ),
    /**
     * User gets diagnoses for an office visit
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Baby", true ),
    /**
     * Patient views diagnoses
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "bypassing", true ),
    /**
     * HCP creates diagnosis
     */
    DIAGNOSIS_CREATE ( 1009, "Producer", true ),
    /**
     * HCP edits diagnosis
     */
    DIAGNOSIS_EDIT ( 1010, "enhance", true ),
    /**
     ...
     */
    DRUG_EDIT ( 901, "interface", true ),
    /**
     * Admin deleted an existing drug
     */
    DRUG_DELETE ( 902, "Money Market Account", true ),
    /**
     * Admin views all drugs in the system
     */
    DRUG_VIEW ( 903, "Metal", true ),

    /**
     * HCP created a new prescription
     */
    PRESCRIPTION_CREATE ( 910, "indigo", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "driver", true ),
    /**
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1101, "gold", true ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "Rustic Soft Towels", true ),
    /**
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1401, "enable", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "Avon", true ),
    /**
     * An email would be sent but email address is missing.
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "Grocery", true );
